...
initial begin
    ...
    axi_slave_write_from_file(
        ...
        2,              // 每次传输后的延迟
        2'b10,          // mem_sel选择C矩阵
        "D:/Desktop/testcase/fp16/m8n32k16/c_fp16_m8n32k16.mem.txt" //文件路径
    );
    ...
    axi_slave_write_from_file(
        ...
        2,              // 每次传输后的延迟
        2'b00,          // mem_sel选择A矩阵
        "D:/Desktop/testcase/fp16/m8n32k16/a_fp16_m8n32k16.mem.txt" // 文件路径
    );
    ...
    axi_slave_write_from_file(
        ...
        2,              // 每次传输后的延迟
        2'b01,          // mem_sel选择B矩阵
        "D:/Desktop/testcase/fp16/m8n32k16/b_fp16_m8n32k16.mem.txt" // 文件路径
    );
